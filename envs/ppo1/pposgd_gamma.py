...
class PPO1_gamma(ActorCriticRLModel):
    """
    ...
    """
    def __init__(self, policy, env, gamma=0.99, timesteps_per_actorbatch=256, clip_param=0.2, entcoeff=0.02,
                 optim_epochs=8, optim_stepsize=1e-3, optim_batchsize=64, lam=0.8, adam_epsilon=1e-5,
            ...
            with self.sess.as_default():
                ...
                while True:
                    ...
                    if self.schedule == 'constant':
                        ...
                        if timesteps_so_far>=1000000:
                           timesteps_learning=2000000
                        else:
                           timesteps_learning=1000000   
                        # total_timesteps =1000000
                        cur_lrmult = max(1.0 - float(timesteps_so_far) / timesteps_learning, 0)
                    else:
